...
test.describe('Audit Logs E2E Tests', () => {
  test('should show editor input and history section in Log Modal', async ({ page }) => {
    ...
    try {
      ...
      const historyTitle = page.locator('h3:has-text("ประวัติการแก้ไข"), h3:has-text("Edit History")');
